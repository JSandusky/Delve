...
static void ImGui_ImplDX11_CreateFontsTexture()
{
    ...
    for (auto font : fontTables_)
    {
        font.second->GetTexDataAsRGBA32(&pixels, &width, &height);
        ...
        ID3D11ShaderResourceView* fontView = 0x0;
        g_pd3dDevice->CreateShaderResourceView(pTexture, &srvDesc, &fontView);
        pTexture->Release();
        
        font.second->TexID = fontView;
    }
    if (fontTables_.empty())
    {
...
void ImGui_ImplDX11_CreateWindow(ImGuiViewport* viewport)
{
...
void ImGui_ImplDX11_DestroyWindow(ImGuiViewport* viewport)
{
...
void ImGui_ImplDX11_SetWindowSize(ImGuiViewport* viewport, ImVec2 size)
{
...
void ImGui_ImplDX11_RenderWindow(ImGuiViewport* viewport, void*)
{
    ImGuiViewportDataDx11* data = (ImGuiViewportDataDx11*)viewport->RendererUserData;
...
void ImGui_ImplDX11_SwapBuffers(ImGuiViewport* viewport, void*)
{
    ImGuiViewportDataDx11* data = (ImGuiViewportDataDx11*)viewport->RendererUserData;

...
namespace ImGuiCLI {
    ...
    public:
        ...
        static property Vector2 MouseDelta { Vector2 get(); }
        ...
        static property float CurrentDPI { float get(); }
    };
    ...
    public:
        ...
        static bool BeginPopupModal(System::String^ title, ImGuiWindowFlags_ windowFlags);
    ...
    /// Drawing Functions
        static void AddLine(Vector2 a, Vector2 b, Color color, float thickness);
    };

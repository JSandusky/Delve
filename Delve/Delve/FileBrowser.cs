...
namespace ImGuiControls
{
    public class FileBrowser
    {
        ...
        public void DrawMenuBar()
        {
            ...
            float starW = ImGuiCli.CalcTextSize(ICON_FA.LIST_UL + " + " + ICON_FA.STAR).X + ImGuiStyle.FramePadding.X*3*ImGuiIO.CurrentDPI;
            ImGuiCli.PushItemWidth(ImGuiCli.GetContentRegionAvailWidth() * 0.7f - starW);
            filter_.Draw(ICON_FA.FILTER + " Filter");
            ImGuiCli.PopItemWidth();

            //ImGuiEx.PushBoldFont();
            ImGuiCli.SetCursorPosX(ImGuiCli.GetWindowWidth() - starW); //70);

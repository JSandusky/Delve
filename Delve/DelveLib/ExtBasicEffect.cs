...
namespace DelveLib
{
    ...
    /// </summary>
    public class ExtBasicEffect : Effect, IEffectMatrices, IEffectLights, IEffectFog
    {
        ...
        Matrix[] instanceTransforms = null;
        ...
        /// </summary>
        public ExtBasicEffect(GraphicsDevice device, ContentManager content, string effect)
            : base(content.Load<Effect>(effect))
        {
        ...
        /// </summary>
        protected ExtBasicEffect(ExtBasicEffect cloneSource)
            : base(cloneSource)
        {
        ...
        {
            return new ExtBasicEffect(this);
        }
        ...
        /// </summary>
        void CacheEffectParameters(ExtBasicEffect cloneSource)
        {
